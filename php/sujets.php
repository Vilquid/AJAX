...
<body>
    ...
    <div class="container my-3">
        <nav class="breadcrumb ">
            <h6 class="breadcrumb-item active"><a href="/AJAX/php/forums.php">Index</a> &nbsp;/&nbsp; <a href="/AJAX/php/sujets.php" class="font-weight-bold">Nom du forum</a> </h6>
        </nav>
            ...
            <div class="container-fluid mt-100">
                ...
                <div class="card mt-3 mb-3">
                    ...
                    <div class="card-body py-3">
                        <div class="row no-gutters align-items-center">
                            <div class="col"> <a href="/AJAX/php/posts.php" class="text-big" data-abc="true">Les origines de OuahJax</a>
